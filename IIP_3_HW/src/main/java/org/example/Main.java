...
import org.example.model.FileOperationTXT;
...
public class Main {
    private static Validation validationDate = new Validation();


    public static void main(String[] args) throws IOException, ValidationException {
        FileOperationTXT fileOperationTXT = new FileOperationTXT();
        Repository repository = new Repository(fileOperationTXT);
        UserController userController = new UserController(repository);
        View view = new View(userController);
        view.run();
